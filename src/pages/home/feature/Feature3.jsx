            ...
            <section className="p-8 font-[sans-serif] border shadow-sm">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 justify-center items-center gap-4">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-xl mb-8">Upgrade to our premium plan and supercharge your experience. Don't miss out!</p>
                        <button className="bg-[#fde047] text-emerald-500 flex items-center hover:bg-opacity-80 py-3 px-10 text-lg lg:text-xl font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl gap-2">
