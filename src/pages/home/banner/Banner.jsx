    ...
    return (
        <div>
            <div className='lg:w-1/2 w-10/12 mx-auto my-2'>
                <h1 
                className='text-center text-3xl font-bold py-1 text-[#10b981]'
                data-aos="flip-left"
                data-aos-delay="50"
                ...
                >See All Queries allows users to access a comprehensive list of all submitted inquiries, facilitating thorough exploration of alternative product options.</p>
