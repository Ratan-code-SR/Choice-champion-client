    ...
    return (
        <div>
            <div className='w-full bg-center relative z-0  h-[500px]'>
                ...
                <div className="absolute md:left-20 left-10 lg:top-1/3 top-2/4 lg:w-3/5 ">
                    <h1 className=" text-white lg:text-5xl md:text-5xl text-2xl  ">Discover Sustainable Alternatives  for Everyday Products</h1>
