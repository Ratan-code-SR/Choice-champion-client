    ...
    return (
        <div className="bg-white dark:bg-gray-900 p-5">
            <div className="flex flex-row-reverse rounded-md justify-center min-h-[calc(100vh-306px)]">
                <div className="hidden bg-cover lg:block rounded-md lg:w-1/2" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1616763355603-9755a640a287?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80)' }}>
                ...
                <div className="flex items-center w-full h-auto max-w-md px-6 mx-auto lg:w-1/2 border p-1 shadow-lg rounded-md">
                    <div className="flex-1">
                        <div className="text-center">
                            ...
                            <p className="text-black text-xl font-bold">Sign Up to access your account</p>
                        </div>
                        <button onClick={handleGoogleLogin} className="flex w-full items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <span className="mx-2 text-black font-bold">Sign in with Google</span>
                        </button>
                            ...
                            <form onSubmit={handleSubmitCreateUser}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full px-4 py-2 mt-2 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
